...
class Direcao:
    rot_dir_dct = {NORTE: LESTE, LESTE: SUL, SUL: OESTE, OESTE: NORTE}
    rot_esq_dct = {NORTE: OESTE, LESTE: NORTE, SUL: LESTE, OESTE: SUL}

    def __init__(self):
        self.valor = rot[0]

    def girar_a_direita(self):
        self.valor = rot_dir_dct[self.valor]

    def girar_a_esquerda(self):
        self.valor = rot_eq_dct[self.valor]
